...
const PRODUCTS = {
  ...
  'HE-1366': { name: '1 Pc Fried Chicken', price: 71, catId: 26 },
  'HE-1367': { name: '2 Pcs Fried Chicken', price: 143, catId: 26 },
  'HE-1368': { name: '4 Pcs Fried Chicken', price: 266, catId: 26 },
  'HE-1369': { name: 'Duet Combo', price: 181, catId: 26 },
  'HE-1370': { name: 'Regular Combo', price: 352, catId: 26 },
  'HE-1371': { name: 'Family Combo', price: 666, catId: 26 },
  'HE-1372': { name: 'Party Combo', price: 951, catId: 26 },
  'HE-1373': { name: 'Cheesy Fries', price: 143, catId: 26 },
  'HE-1374': { name: 'Loaded Fries', price: 181, catId: 26 },
  'HE-1375': { name: 'Krispy Popcorn (S)', price: 76, catId: 26 },
  'HE-1376': { name: 'Krispy Popcorn (M)', price: 143, catId: 26 },
  'HE-1377': { name: 'Krispy Popcorn (L)', price: 219, catId: 26 },
  'HE-1378': { name: 'Krispy Shrimps with Mayo (10pcs)', price: 237, catId: 26 },
  'HE-1379': { name: 'Krispy Wings with Mayo (6pcs)', price: 94, catId: 26 },
  'HE-1380': { name: 'Krispy Lollipop with Mayo (6pcs)', price: 123, catId: 26 },
  'HE-1381': { name: 'Chicken Zinger Burger', price: 171, catId: 26 },
  'HE-1382': { name: 'Classic Chicken Burger', price: 124, catId: 26 },
  'HE-1383': { name: 'Chicken Zinger Roll', price: 152, catId: 26 },
  'HE-1384': { name: 'Mutton Sheekh Roll', price: 152, catId: 26 },
  'HE-1385': { name: 'Shawarma Roll', price: 76, catId: 26 },
  'HE-1386': { name: 'Chicken Popcorn Salad', price: 181, catId: 26 },
  'HE-1387': { name: 'Chicken Doner Salad', price: 181, catId: 26 },
  'HE-1388': { name: 'Rice with Chicken Popcorn', price: 181, catId: 26 },
  'HE-1389': { name: 'Extra Bun', price: 14, catId: 26 },
  'HE-1390': { name: 'Extra Mayo', price: 19, catId: 26 },
  'HE-1391': { name: 'Soft Drink', price: 38, catId: 26 },
};
