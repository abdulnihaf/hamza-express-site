...
const WA_URL = 'https://wa.me/918008002049?text=Hi%20Hamza%20Express%2C%20I%20searched%20for%20Hamza%20on%20Google.%20Please%20share%20the%20menu%20and%20location.';
...
<title>Hamza Express HKP Road</title>
<style>
:root{color-scheme:dark;--bg:#090d12;--card:#151c25;--line:#2a3544;--text:#f8fafc;--muted:#a7b0bd;--green:#22c55e;--gold:#f5b84b;--blue:#60a5fa}
...
.primary{background:var(--green);color:#06130b}.secondary{border:1px solid var(--line);color:var(--text);background:#0f151d}.fine{font-size:12px;color:var(--muted);text-align:center;margin-top:14px}.brand{color:var(--blue);font-weight:800}
</style>
</head>
<body>
<main>
  <div class="kicker">Hamza brand search</div>
  <h1>Hamza Express, HKP Road</h1>
  <p>If you searched for <span class="brand">Hamza</span>, <span class="brand">Hamza Hotel</span>, or <span class="brand">Hamza Express</span>, this is the correct Hamza Express pin for biryani, kabab and ghee rice.</p>
  <div class="proof">
    <div><strong>Correct pin</strong>HKP Road, Shivajinagar</div>
    <div><strong>Food memory</strong>Same Hamza taste</div>
