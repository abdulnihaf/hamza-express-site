...
public class HEFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private static final String TAG = "HEFirebase";
    private static final String CHANNEL_ID = "he_orders";
    ...
    public void onNewToken(String token) {
        ...
        // Store token locally — will be sent to server when user logs in
        SharedPreferences prefs = getSharedPreferences(PREFS_NAME, MODE_PRIVATE);
        prefs.edit().putString("fcm_token", token).apply();
        // Try to send to server if we have auth info
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        String tag = data.containsKey("tag") ? data.get("tag") : "he_order_" + System.currentTimeMillis();
    ...
    private void showAlarmNotification(String title, String body, String tag, String url) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setDefaults(0) // Don't use defaults — we set sound+vibrate explicitly
                .setVisibility(NotificationCompat.VISIBILITY_PUBLIC);

        // Full-screen intent for lock screen wake-up (Android 10+)
    ...
    private void sendTokenToServer(String fcmToken) {
        ...
        new Thread(() -> {
            try {
                URL apiUrl = new URL("https://hamzaexpress.in/api/whatsapp?action=floor-push-subscribe");
